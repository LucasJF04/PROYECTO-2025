    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('categorias.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash mr-3"></i>Borrar búsqueda</a>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive rounded mb-3">
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            <td>{{ (($categorias->currentPage() * 10) - 10) + $loop->iteration  }}</td>
