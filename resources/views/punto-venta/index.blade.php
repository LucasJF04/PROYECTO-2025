            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <form action="{{ route('pos.updateCart', $item->rowId) }}" method="POST">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Actualizar"><i class="fas fa-check"></i></button>
                                    </div>
                                </div>
                            </form>
                        </td>
                        ...
                        <td>{{ $item->subtotal }}</td>
                        <td>
                            <a href="{{ route('pos.deleteCart', $item->rowId) }}" class="btn btn-danger border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Eliminar"><i class="fa-solid fa-trash mr-0"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="d-flex flex-wrap align-items-center justify-content-center">
                            <a href="{{ route('clientes.create') }}" class="btn btn-primary add-list mx-1">Añadir cliente</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('pos.addCart') }}" method="POST"  style="margin-bottom: 5px">
                                            ...
                                            <button type="submit" class="btn btn-primary border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Añadir"><i class="far fa-plus mr-0"></i></button>
                                        </form>
                                    </td>
                                </tr>
