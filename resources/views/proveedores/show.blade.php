...
e -->
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="{{ route('proveedores.edit', $proveedor->id) }}" class="btn btn-primary font-size-14">Edit</a>
                            <a href="{{ route('proveedores.index') }}" class="btn btn-danger font-size-14">Back</a>
                        </div>
                    </div>
        ...
        <!-- end: Left Detail Empleado
e -->

        <!-- begin: Right Detail Empleado
e -->
