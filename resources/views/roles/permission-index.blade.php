        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un panel de permisos le permite recopilar y visualizar fácilmente los datos de permisos <br>
                        , optimizando la experiencia de permisos y garantizando la retención de los mismos. </p>
                </div>
                <div>
