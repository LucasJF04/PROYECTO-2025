    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Lista de Roles con Permisos</h4>
                </div>
                <div>
                    <a href="{{ route('rolePermission.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>Agregar Rol con Permiso</a>
                </div>
            </div>
        </div>

        {{-- Filtro de búsqueda (comentado) --}}
        {{-- 
        <div class="col-lg-12">
                            ...
                            <td>
                                <form action="{{ route('rolePermission.destroy', $role->id) }}" method="POST" style="margin-bottom: 5px">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        ...
                                        <button type="submit" class="btn btn-warning mr-2 border-none" onclick="return confirm('¿Está seguro de eliminar este registro?')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Eliminar"><i class="ri-delete-bin-line mr-0"></i></button>
                                    </div>
                                </form>
                            </td>
                        </tr>
