        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un panel de roles le permite recopilar y visualizar fácilmente los datos de los roles, optimizando<br>
                         la experiencia del rol y garantizando su retención. </p>
                </div>
                <div>
                    <a href="{{ route('role.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>Añadir rol</a>
                </div>
            </div>
        </div>
